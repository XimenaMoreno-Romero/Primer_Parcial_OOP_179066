package PixelArt;
	...
	public class GeneradorImage {
		 ...
		 static Color rojoPD= new Color (218,30,43,255);
		 static Color grisD= new Color (76,76,92,255);
		 static Color rojoD= new Color (174,31,64,255);
		 static Color piel= new Color (225,223,178,255);
		 static Color amarillo= new Color (237,211,73,255);
		    ...
		    public static BufferedImage Imagen5(){
		        ...
		        int width = 1200, height = 1350, PIXEL_SIZE = 40;
		        BufferedImage bufferedImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
		        Graphics2D graphics2D = bufferedImage.createGraphics();
		        ImagenConfig.fondo(bufferedImage, Color.WHITE);
		        ImagenConfig.cuadricula(bufferedImage, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 10, 0, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 11, 0, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 12, 0, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 9, 1, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 1, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 1, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 1, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 13, 1, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 14, 1, PIXEL_SIZE);
		      
		
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 10, 2, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 11, 2, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 2, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 2, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 14, 2, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 15, 2, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 8, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 9, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 10, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 11, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 13, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 14, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 15, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 16, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 17, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 18, 3, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 19, 3, PIXEL_SIZE);
		        
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 7, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 8, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 9, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 14, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 15, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 16, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 17, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 18, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 19, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 20, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 22, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 23, 4, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 24, 4, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 6, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 7, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 8, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 9, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 10, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 11, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 14, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 15, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 16, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 17, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 18, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 19, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 20, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 21, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 22, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 23, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 24, 5, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 25, 5, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 5, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 6, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 7, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 8, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 9, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 12, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 13, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 14, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 15, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 16, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 17, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 18, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 19, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 20, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 21, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 22, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 23, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 24, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 25, 6, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 26, 6, PIXEL_SIZE);
		       
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 4, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 2, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 5, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 6, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 7, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 8, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 9, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 14, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 15, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 16, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 17, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 18, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 19, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 20, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 21, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 22, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 23, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 24, 7, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 25, 7, PIXEL_SIZE);  
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 26, 7, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 1, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 3, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.WHITE, 7, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 5, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 2, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 6, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 4, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 8, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 9, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 14, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 15, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 16, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 17, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 18, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 19, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 20, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 21, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 22, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 23, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 24, 8, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 25, 8, PIXEL_SIZE);  
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 26, 8, PIXEL_SIZE);
		        
		        ImagenConfig.Pixel(bufferedImage, Color.BLACK, 0, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, Color.WHITE, 7, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 1, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoD, 2, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 3, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 5, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 4, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 8, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 9, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 10, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 11, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 12, 9, PIXEL_SIZE);
		        ImagenConfig.Pixel(bufferedImage, rojoPD, 13, 9, PIXEL_SIZE);
